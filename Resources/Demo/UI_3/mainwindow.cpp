    ...
    ui_main(new Ui::MainWindow)
{
    ...
    //将ui_main中的button对象复制到Btn_array数组中
    ...
    QImage newImg = img.scaled(300,300);//设定大小
    QPixmap cutPic1[9];
    QIcon cutIcon[9];
    for(int i=1;i<9;i++){
    ...
    ui_main->pushButton_1->setIconSize(QSize(100,100));
    ui_main->pushButton_2->setIcon(cutIcon[2]);
    ui_main->pushButton_2->setIconSize(QSize(100,100));
    ui_main->pushButton_3->setIcon(cutIcon[3]);
    ui_main->pushButton_3->setIconSize(QSize(100,100));
    ui_main->pushButton_4->setIcon(cutIcon[4]);
    ui_main->pushButton_4->setIconSize(QSize(100,100));
    ui_main->pushButton_5->setIcon(cutIcon[5]);
    ui_main->pushButton_5->setIconSize(QSize(100,100));
    ui_main->pushButton_6->setIcon(cutIcon[6]);
    ui_main->pushButton_6->setIconSize(QSize(100,100));
    ui_main->pushButton_7->setIcon(cutIcon[7]);
    ui_main->pushButton_7->setIconSize(QSize(100,100));
    ui_main->pushButton_8->setIcon(cutIcon[8]);
    ui_main->pushButton_8->setIconSize(QSize(100,100));
...
{
    QIcon tem_icon = Btn_array[m]->icon();
    Btn_array[m]->setIcon(Btn_array[n]->icon());
    Btn_array[n]->setIcon(tem_icon);
    int tem = data_btn[m];
